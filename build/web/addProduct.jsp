        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="AddProductServlet">Thêm sản phẩm</a></li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        ...
                        <div class="tile-body">
                            <form class="row" action="AddProductServlet" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-3">
                                    <label class="control-label">ID người tạo</label>
