        ...
        <script  type="text/javascript">
            function doDelete(customerId) {
                if (confirm("Do you want to delete this customer?")) {
                    window.location = "DeleteCustomerServlet?customerId=" + customerId;
                }
            }
        </script>
        <style>
                        ...
                        <div class="tile-body">    
                            <div class="row element-button">
                                <div class="col-sm-2">
                                    ...
                                    <a class="btn btn-add btn-sm" href="AddCustomerServlet" title="Thêm"><i class="fas fa-plus"></i>
                                        Add Customer</a>
                                </div>
                                <div class="col-sm-2">
                                ...
                                <tbody>
                                    <c:forEach items="${requestScope.customers}" var="customer">
                                        <tr>
                                            ...
                                            <td width="100px">
                                                <img src="<c:url value='/assets/img/${customer.image}'/>" alt="" width="100px;">
                                            </td>
                                            <td>${customer.email}</td>
                                            <td>${customer.phone}</td>
                                            <td>${customer.address}</td>
                                            <td class="table-td-center"><button class="btn btn-primary btn-sm trash" type="button" title="Delete"
                                                                                onclick="doDelete('${customer.customerId}')"><i class="fas fa-trash-alt"></i>
                                                </button>
                                                <a class="btn btn-primary btn-sm edit" href="UpdateCustomerServlet?customerId=${customer.customerId}" title="Update">
                            ...
                            <c:forEach begin="1" end="${endP}" var="i">
                                <a class="${tag == i?"active":""}" id="indexPage" href="ListCustomerServlet?index=${i}">${i}</a>
                            </c:forEach>
