<%-- 
    Document   : Signup
    Created on : Mar 4, 2024, 11:46:51 AM
    Author     : PC
--%>
    ...
    <body>
        <div class="signup-form">
            <form action="signup" method="post">
                <h2>Đăng ký</h2>
                <p class="hint-text">Tạo tài khoản của bạn</p>
                ...
                <div class="form-group">
                    <input type="password" class="form-control" name="confirm_password" placeholder="Xác thực mật khẩu" required="required">
                </div>   
                <div class="form-group">
            ...
            <div class="text-center">Bạn đã có tài khoản? <a href="LoginController">Đăng nhập</a></div>
        </div>
    </body>
</html>
