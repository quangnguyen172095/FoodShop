...
public class Order {
    ...
    public Order(int OrderID, String OrderStatus, Date OrderDate, String PaymentMethod, String ShippingAddress, float Freight, int CreatedBy, Date CreatedOn, String TransactionStatus, Customers customers) {
    ...
    public Order(int OrderID, int CustomerID, String OrderStatus, Date OrderDate, String PaymentMethod, String ShippingAddress, float Freight, int CreatedBy, Date CreatedOn, String TransactionStatus, Customers customers) {
        this.OrderID = OrderID;
        this.CustomerID = CustomerID;
        this.OrderStatus = OrderStatus;
        this.OrderDate = OrderDate;
    ...
    public Order(int OrderID, Customers customers, String OrderStatus, Date OrderDate, String PaymentMethod, String ShippingAddress, float Freight,int CreatedBy, Date CreatedOn, String TransactionStatus) {
     this.OrderID = OrderID;
        this.customers = customers;
        this.OrderStatus = OrderStatus;
        this.OrderDate = OrderDate;
        ...
        public Order(int OrderID, Customers customers,Admin a, String OrderStatus, Date OrderDate, String PaymentMethod, String ShippingAddress, float Freight,int CreatedBy, Date CreatedOn, String TransactionStatus) {
     this.OrderID = OrderID;
        this.customers = customers;
        this.createdByAdmin = a;
        this.OrderStatus = OrderStatus;
        this.OrderDate = OrderDate;
        this.PaymentMethod = PaymentMethod;
        this.ShippingAddress = ShippingAddress;
