<%-- 
    ...
    Created on : Mar 10, 2024, 11:33:56 AM
    Author     : PC
--%>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col d-flex flex-column flex-sm-row justify-content-between mb-3">
                                                <div class="text-center text-sm-left mb-2 mb-sm-0">
                                                    ...
                                                    <h5 style="color: green; margin-bottom: 30px">${requestScope.success}</h5>
                                                    <div class="mt-2">
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control" type="password" name="passwordnew1">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control" type="password" name="passwordnew2"></div>
                                                                </div>
                                                            </div>
                                                        </div>
