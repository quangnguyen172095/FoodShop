    ...
    <body class="app sidebar-mini rtl">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li><a class="app-menu__item active" href="ListCustomerServlet"><i class='app-menu__icon bx bx-user-voice'></i><span
        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb">
                    <li class="breadcrumb-item"><a href="ListAdminServlet">List of Customers</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        <h3 class="tile-title">Update Customers</h3>
                        <form class="" action="UpdateCustomerServlet" method="post" >
                            <c:set var="cus" value="${requestScope.customer}"/>
                            <div class="tile-body row">

                                <div class="form-group col-md-3">
                                    <label class="control-label">Customer ID</label>
                                    <input class="form-control" type="text" name="customerId" value="${cus.customerId}" readonly >
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="control-label">Full Name</label>
                                    <input class="form-control" type="text" name="fullName" value="${cus.fullName}">
                                </div>
                                <div class="form-group  col-md-3">
                                    <label class="control-label">Username</label>
                                    <input class="form-control" type="text" name="username" value="${cus.username}">
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="control-label">Password</label>
                                    <input class="form-control" type="text" name="password" value="${cus.password}">
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="control-label">Email</label>
                                    <input class="form-control" type="text" name="email" value="${cus.email}">
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="control-label">Phone</label>
                                    <input class="form-control" type="text" name="phone" value="${cus.phone}">
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="control-label">Address</label>
                                    <input class="form-control" type="text" name="address" value="${cus.address}">
                                </div>
                            </div>
                            <input class="btn btn-save" type="submit" value="Save"/>
                            <a class="btn btn-cancel" href="ListCustomerServlet">Cancel</a>
                        </form>
                    </div>
                    </main>
