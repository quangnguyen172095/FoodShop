        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb side">
                    <li class="breadcrumb-item active"><a href="#"><b>List of Category</b></a></li>
                </ul>
                <div id="clock"></div>
            </div>
                        ...
                        <div class="tile-body">    
                            <div class="row element-button">
                                <div class="col-sm-2">
                                    ...
                                    <a class="btn btn-add btn-sm" href="AddCategoryServlet" title="Thêm"><i class="fas fa-plus"></i>
                                        Add Category</a>
                                </div>
                                <div class="col-sm-2">
                                ...
                                <tbody>
                                    <c:forEach items="${requestScope.listCate}" var="lc">
                                        <tr>
                                            ...
                                            <td>${lc.getCategoryID()}</td>
                                            <td>${lc.getCategoryName()}</td>
                                            <td class="table-td-center"><button class="btn btn-primary btn-sm trash" type="button" title="Delete"
                                                                                onclick="doDelete('${lc.getCategoryID()}')"><i class="fas fa-trash-alt"></i>
                                                </button>
