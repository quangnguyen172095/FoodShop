        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb">
                    <li class="breadcrumb-item"><a href="ListCategoryServlet">List of Category</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        ...
                        <form class="" action="UpdateCategoryServlet" method="post" >
                            <c:set var="cate" value="${requestScope.category}"/>
                            <div class="tile-body row">

                                <div class="form-group col-md-3">
                                    <label class="control-label">Customer ID</label>
                                    <input class="form-control" type="text" name="categoryId" value="${cate.getCategoryID()}" readonly >
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="control-label">Category Name</label>
                                    <input class="form-control" type="text" name="categoryName" value="${cate.getCategoryName()}">
                                </div>
                                
                            </div>
                            <input class="btn btn-save" type="submit" value="Save"/>
                            <a class="btn btn-cancel" href="ListCategoryServlet">Cancel</a>
                        </form>
                    </div>
                    </main>
