        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb">
                    <li class="breadcrumb-item"><a href="ListAdminServlet">List of Employees</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        ...
                        <div class="tile-body">
                            <form class="row" action="UpdateAdminServlet" method="POST">                         
                                <c:set var="admin" value="${requestScope.admin}"/>
                                <div class="form-group col-md-3">
                                    <label class="control-label">Employee ID</label>
                                    <input class="form-control" type="text" name="adminId" value="${param.adminId}" readonly >
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="control-label">Full Name</label>
                                    <input class="form-control" type="text" name="fullName" value="${admin.fullName}">
                                </div>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input class="form-control" type="text" name="role" value="${admin.role}" readonly>
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="control-label">Joined Date</label>
                                    <input class="form-control" type="text" name="joinedDate" value="${admin.joinedDate}" readonly>
                                </div>
                                <div class="form-group col-md-3">
