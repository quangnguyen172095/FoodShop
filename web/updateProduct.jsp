                            ...
                            <form class="row" action="UpdateProductServlet" method="post">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="form-control" id="exampleSelect1" name="category">
                                        ...
                                        <option ${product.categories.categoryName eq 'Beverages' ? 'selected' : ''}>Beverages</option>
                                        <option ${product.categories.categoryName eq 'Appetizers' ? 'selected' : ''}>Appetizers</option>
                                        <option ${product.categories.categoryName eq 'Meat & Poultry' ? 'selected' : ''}>Main Courses</option>
                                        <option ${product.categories.categoryName eq 'Desserts' ? 'selected' : ''}>Desserts</option>
                                        <option ${product.categories.categoryName eq 'Snacks' ? 'selected' : ''}>Snacks</option>
                                        <option ${product.categories.categoryName eq 'Seafood' ? 'selected' : ''}>Seafood</option>
                                        <option ${product.categories.categoryName eq 'Vegetarian' ? 'selected' : ''}>Vegetarian</option>
                                        <option ${product.categories.categoryName eq 'Bakery' ? 'selected' : ''}>Bakery</option>
                                        <option ${product.categories.categoryName eq 'Steakhouse' ? 'selected' : ''}>Steakhouse</option>
                                        <option ${product.categories.categoryName eq 'International Cuisine' ? 'selected' : ''}>International Cuisine</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-3">
