        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb side">
                    <li class="breadcrumb-item active"><a href="#"><b>List of Employees</b></a></li>
                </ul>
                <div id="clock"></div>
            </div>
                        ...
                        <div class="tile-body">
                            ...
                            <div class="row element-button">
                                <div class="col-sm-2">
                                    ...
                                    <a class="btn btn-add btn-sm" href="AddAdminServlet" title="Add"><i class="fas fa-plus"></i>
                                        Add Employee</a>
                                </div>
                                <div class="col-sm-2">
                                ...
                                <tbody>
                                    <c:forEach items="${requestScope.admins}" var="admin">
                                        <tr>
                                            ...
                                            <td width="100px">
                                                <img src="<c:url value='/assets/img/${admin.image}'/>" alt="" width="100px;">
                                            </td>
                                            <td>${admin.email}</td>
                                            <td>${admin.phone}</td>
                                            <td>${admin.role}</td>
                                            ...
                                            <td class="table-td-center"><button class="btn btn-primary btn-sm trash" type="button" title="Delete"
                                                                                onclick="doDelete('${admin.adminId}')"><i class="fas fa-trash-alt"></i>
                                                </button>
                                                <a class="btn btn-primary btn-sm edit" href="UpdateAdminServlet?adminId=${admin.adminId}" title="Update">
                            ...
                            <c:forEach begin="1" end="${endP}" var="i">
                                <a class="${tag == i?"active":""}" id="indexPage" href="ListAdminServlet?index=${i}">${i}</a>
                            </c:forEach>
